...
class CouponsTest < ApplicationSystemTestCase
  ...
  test "creating a Coupon" do
    ...
    fill_in "D-price", with: @coupon.D-price
    fill_in "Expireddate", with: @coupon.expireddate
    fill_in "Precentage", with: @coupon.precentage
    fill_in "Usagenum", with: @coupon.usagenum
