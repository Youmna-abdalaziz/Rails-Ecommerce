...
User.create(email: "faten@yahoo.com",password: '123456',name:"faten",is_seller: true,id:7)
User.create(email: "soha@yahoo.com",password: '123456',name:"soha",is_seller: true,id:8)
